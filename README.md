...
Ce projet, réalisé dans le cadre de ma candidature Data Engineer chez Simplon, démontre ma capacité à concevoir et déployer une chaîne de traitement de données complète
